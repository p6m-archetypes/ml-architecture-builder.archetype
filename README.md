# ML Architecture Builder archetype

This is an [Archetect](https://archetect.github.io/) archetype, designed for generating a variety of components for a Machine Learning architecture.
